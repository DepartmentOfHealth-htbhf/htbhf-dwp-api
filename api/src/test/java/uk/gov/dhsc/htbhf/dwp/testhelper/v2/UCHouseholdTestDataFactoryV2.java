...
public class UCHouseholdTestDataFactoryV2 {
    ...
    public static UCHousehold aUCHouseholdWithAdultMobileAndEmail(String mobile, String email) {
        return aUCHouseholdWithNoAdultsOrChildren()
                .build()
                .addAdult(aUCAdult(SIMPSON_SURNAME, HOMER_NINO, HOMER_DATE_OF_BIRTH, mobile, email))
                .addAdult(MARGE)
                .addChild(BART)
                .addChild(LISA)
                .addChild(MAGGIE);
    ...
    public static UCHousehold aUCHouseholdWithAdultDateOfBirth(LocalDate dateOfBirth) {
        return aUCHouseholdWithNoAdultsOrChildren()
                .build()
                .addAdult(aUCAdult(SIMPSON_SURNAME, HOMER_NINO, dateOfBirth, HOMER_MOBILE, HOMER_EMAIL))
                .addAdult(MARGE)
                .addChild(BART)
                .addChild(LISA)
                .addChild(MAGGIE);
